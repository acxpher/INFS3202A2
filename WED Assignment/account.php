...
<div class="container">
	 ...
	 <div class="registration">
		 <div class="registration_left">
			 ...
			 <!-- Form -->
				<form form action="account/handleCreate.php" class="form-horizontal" method="post">
					<div>
						<label>
							<input placeholder="first name" type="text" tabindex="1" name="f_name">
						</label>
					</div>
					<div>
						<label>
							<input placeholder="last name" type="text" tabindex="2" name="l_name">
						</label>
					</div>
					<div>
						<label>
							<input placeholder="email address" type="email" tabindex="3"name="email">
						</label>
					</div>
					<div>
						<label>
							<input placeholder="Mobile" type="text" tabindex="3" name="mobile">
						</label>
					</div>
						<div class="sky_form1">
							<ul>
